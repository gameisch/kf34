...
$(document).ready(function () {
    var sliderContainer = $('.infoblock-2s-image-slider');
    var lengSlides = $('.infoblock-2s-image-slider > .swiper-wrapper > .swiper-slide');
...
$(document).ready(function () {
    ...
    var catSlider = new Swiper('.cat-tabs-wrapper .swiper-container', {
        slidesPerView: 1,
        loop: false,
...
$(document).ready(function () {
    $('.image-slider__slider').each(function () {
        ...
        var imageSlider = new Swiper(swiperContainer, {
            loop: isLoop,
            autoplay: isAutoplay,
            slidesPerView: 3,
            navigation: {
...
$(document).ready(function () {
    var partTemplate = $('.inquiry-step__part').html();
    $('#addPart').click(function () {
        $('.inquiry-step__parts').append('<div class="inquiry-step__part">' + partTemplate + '</div>').find('.inquiry-step__part').last().find('select').styler({ selectSmartPositioning: false, locale: 'en' });
...
function initMap() {
    ...
    var locations = [['loc1', 48.671672, 44.466652, 1], ['loc2', 48.671944, 44.464567, 2]];
    var mapProp = {
        center: centerMap,
        zoom: 16,
        zoomControl: true,
    ...
    for (i = 0; i < locations.length; i++) {
        ...
        var locFunc = google.maps.event.addListener(marker, 'click', function (marker, i) {
            return function () {
...
$(document).ready(function () {
    var $modalRse = $('.rse');
    var $modalRe = $('.re');
    var $serpModalRe = $('.serp-item__request');
    var $modalRpm = $('.rpm');
    var $modalRsc = $('.rsc');
    var $modalRsq = $('.rsq');
    var $modalSt = $('.st');
    var $modalStore = $('.storage');
    var $modalTrans = $('.transportation');
    var $modalReg = $('.reg');
    var $modalParts = $('.rp');
    var $modClose = $('.modal-content__close');
    var $body = $('body');
    var modal = function modal(id) {
        var $moData = $('.modal[data-modal=' + id + ']');
    ...
    getFileParam = function getFileParam() {
        try {
            ...
            var filed = $('uploaded-file1').value();
            var fileS = filed.replace(/\\/g, '/').split('/').pop();
    ...
    $('.exp').change(function (x) {
        ...
        x.preventDefault();
        var selected = $('.typeof:selected').val();
        var subTypeSlctd = $('.exp .subtypeof:selected').val();
        var subSubTypeSlctd = $('.subtype .subtypeof:selected').val();
        var $this = $(this).val();
        setTimeout(500);
        var $dataOfselect = $('.hidden[data-open="' + selected + '"]');
        var $dataOfsubType = $('.subhidden[data-open="' + subTypeSlctd + '"]');
        var $dataOfSubSubType = $('.subsubhidden[data-open="' + subSubTypeSlctd + '"]');
        if ($this === selected) {
...
$(document).ready(function () {
    if ($('.product-info__image--mobile').length > 0) {
        var mobileSlider = new Swiper('.product-info__image--mobile', {
            init: false,
            autoHeight: true,
            loop: true,
            slidesPerView: 1,
...
$(document).ready(function () {
    var $rbut = $('.top-re');
    var $requestItemBut = $('.rentals-item__request, .serp-item__request');
    var $childField = $('#radio-quote input[type="radio"]');
    $('.field-show').hide();
    $('.req').hide();
    $('.hidden').hide();
    $('.subhidden').hide();
